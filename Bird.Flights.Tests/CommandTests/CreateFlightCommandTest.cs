...
namespace Bird.Flights.Tests.CommandTests
{
    ...
    {
        private readonly CreateFlightCommand _invalidFlight = new CreateFlightCommand("TAM", "3000", "TAM3000", "1600", "0100", "", "CGH", DateTime.Now.AddHours(-1), DateTime.Now, "A320");
        private readonly CreateFlightCommand _validFlight = new CreateFlightCommand("TAM", "3000", "TAM3000", "1600", "0100","CWB", "CGH", DateTime.Now.AddHours(-1), DateTime.Now, "A320");
